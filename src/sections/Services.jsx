...
export function Services() {
    ...
    return(
        ...
        <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'} pb-20`}>
            ...
            <section id='services' className={`${darkMode ? 'dark bg-gray-800' : 'light bg-red-100'} lg:w-[95%] w-full m-auto h-auto rounded-xl flex flex-col justify-center items-start lg:px-20 px-6 py-20 gap-10`}>

                <div className='flex flex-col justify-center items-start gap-4'>
                    <h1 data-aos="zoom-in" className='text-red-500 dark:text-white font-semibold'>OUR SERVICES</h1>
                ...
                <div id='services-box' className='grid lg:grid-cols-3 grid-cols-1 justify-center text-start gap-8'>
                    {
                        service.map((item, index) => (
                            <div data-aos="zoom-in" data-aos-delay="200" key={index} className='bg-white dark:bg-black h-[350px] px-8  py-16 flex flex-col justify-center items-start gap-4 rounded-xl border-b-[5px] border-red-600 hover:bg-red-300 cursor-pointer'>
                                ...
                                <p className='text-lg text-slate-700 dark:text-white items-start'>{item.desc}</p>
